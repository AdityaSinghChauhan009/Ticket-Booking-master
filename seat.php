...
<HTML>
	...
	<BODY>
		...
		<script type="text/javascript">
		 ...
		 <div style =" width:1175px; height:30px; margin-left:80px; background-color:#E6FF99; position:relative; bottom:500px;"><marquee>The Price of per seat is 1000 INR</marquee></div>
	</BODY>
</HTML>