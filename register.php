...
$select = "select * from register where userid = '" . $userid . "'";
...
mail ("akhilsachan456@gmail.com", "New ticket booked", $email_content);
...
header('Location: book.php?s='.urlencode(" Congrats ". $name ." for booking seat number: ". $seatNumber ." with us.<br>PNR no. for the booking is ". $calcPNR ." <br>Ticket will be shortly recieved to you at ". $email ."<br>")); exit;
