			...
			<form name="contactForm" action="register.php" method="POST" class="form-horizontal">
				<div class='control-group'>
					...
					<?php 
						...
						$rty=$count*1000;
						echo "<br><div class='control-group'><label class='control-label' for='input1'>Price</label><div class='controls'>";
					    echo "<input type='text' class='span3' name='s2' value=".$rty." readonly/><br>"
